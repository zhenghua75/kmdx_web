<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Update_News.aspx.cs" Inherits="admin_Update_News" %>
...
<body>
    ...
    <table width="98%"  border="0" cellpadding="3" align="center" cellspacing="0" bgcolor="#F1EAE0">
         ...
         <tr>
            <td width="100%" class="change_td" style="cursor:hand " >修改新闻</td>
         </tr>
    </table> 
		  ...
		  <tr bgcolor="#eeeeee">
            ...
            <td width="80%" style="height: 30px">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="Title"
                    ErrorMessage="新闻标题不能为空"></asp:RequiredFieldValidator>
