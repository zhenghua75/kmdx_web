<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Update_Job.aspx.cs" Inherits="admin_Update_Job" %>
...
<body>
    ...
    <table width="98%"  border="0" cellpadding="3" align="center" cellspacing="0" bgcolor="#F1EAE0">
         ...
         <tr>
            <td width="100%" class="change_td" style="cursor:hand " >人才招聘修改</td>
         </tr>
    </table> 
    <table width="98%"  border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="cccccc">         
		  <tr bgcolor="#eeeeee">
            ...
            <td width="80%" style="height: 30px">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="Title"
                    ErrorMessage="标题名称不能为空"></asp:RequiredFieldValidator>
        ...
        <tr bgcolor="#eeeeee">
            ...
            <td style="height: 30px" width="80%">
                <asp:Button ID="Update_Btn" runat="server" Text="修改" OnClick="Update_Btn_Click"  /></td>
        </tr>
          <tr bgcolor="#eeeeee">
