<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Add_NewClass.aspx.cs" Inherits="admin_Add_NewClass" %>
...
<body>
    ...
    <table width="98%"  border="0" cellpadding="3" align="center" cellspacing="0" bgcolor="#F1EAE0">
         ...
         <tr>
            <td width="100%" class="change_td" style="cursor:hand " >添加新闻分类</td>
         </tr>
    </table> 
