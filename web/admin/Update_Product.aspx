<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Update_Product.aspx.cs" Inherits="admin_Update_Product" %>
...
<body>
    ...
    <table width="98%"  border="0" cellpadding="3" align="center" cellspacing="0" bgcolor="#F1EAE0">
         ...
         <tr>
            <td width="100%" class="change_td" style="cursor:hand " >修改员商品</td>
         </tr>
    </table> 
    <table width="98%"  border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="cccccc">         
		  <tr bgcolor="#eeeeee">
            ...
            <td width="80%" style="height: 30px">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="Pro_Name"
                    ErrorMessage="商品名称不能为空"></asp:RequiredFieldValidator>
        ...
        <tr bgcolor="#eeeeee">
            ...
            <td style="height: 30px" width="80%">
                ...
                &nbsp;
                <asp:HiddenField ID="Updatatime" runat="server" />
            </td>
        </tr>
        <tr bgcolor="#eeeeee">
            <td align="right" style="width: 186px; height: 30px">
        ...
        <tr bgcolor="#eeeeee">
            ...
            <td style="height: 30px" width="80%">
                <asp:Button ID="Update_Btn" runat="server" Text="修改商品" OnClick="Update_Btn_Click"  /></td>
        </tr>
          <tr bgcolor="#eeeeee">
