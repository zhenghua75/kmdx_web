<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Get_Product.aspx.cs" Inherits="admin_Get_Product" %>
...
<body>
    ...
    <table width="98%"  border="0" cellpadding="3" align="center" cellspacing="0" bgcolor="#F1EAE0">
             ...
             <tr>
                <td width="100%" class="change_td" style="cursor:hand " >商品管理</td>
             </tr>
        </table>   
        <asp:GridView ID="Product_List" DataKeyNames="ID" OnRowDeleting="Product_List_RowDeleting" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" HorizontalAlign="Center" Width="98%" CellSpacing="1" AutoGenerateColumns="False">
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="商品分类">                    
                    <ItemTemplate>
                        <asp:Label ID="Label1" runat="server" Text='<%#Eval("productClass.ClassName")%>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:HyperLinkField DataNavigateUrlFields="ID" DataNavigateUrlFormatString="Update_Product.aspx?ID={0}"
