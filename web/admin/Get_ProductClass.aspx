<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Get_ProductClass.aspx.cs" Inherits="admin_Get_ProductClass" %>
...
<body>
    ...
    <table width="98%"  border="0" cellpadding="3" align="center" cellspacing="0" bgcolor="#F1EAE0">
         ...
         <tr>
            <td width="100%" class="change_td" style="cursor:hand " >商品分类管理</td>
         </tr>
    </table> 
     <asp:GridView ID="ProductClass_List" DataKeyNames="ClassID" OnRowDeleting="ProductClass_List_RowDeleting" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" HorizontalAlign="Center" Width="98%" CellSpacing="1" AutoGenerateColumns="False">
         ...
         <Columns>
             ...
             <asp:HyperLinkField DataNavigateUrlFields="ClassID" DataNavigateUrlFormatString="Update_ProductClass.aspx?ClassID={0}"
