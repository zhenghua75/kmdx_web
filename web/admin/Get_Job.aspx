<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Get_Job.aspx.cs" Inherits="admin_Get_Job" %>
...
<body>
    ...
    <table width="98%"  border="0" cellpadding="3" align="center" cellspacing="0" bgcolor="#F1EAE0">
         ...
         <tr>
            <td width="100%" class="change_td" style="cursor:hand " >人才招聘管理</td>
         </tr>
    </table> 
    
    <asp:GridView ID="Job_List" DataKeyNames="ID" OnRowDeleting="Job_List_RowDeleting" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" HorizontalAlign="Center" Width="98%" CellSpacing="1" AutoGenerateColumns="False">
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Title" HeaderText="人才招聘标题" />                
                <asp:HyperLinkField DataNavigateUrlFields="ID" DataNavigateUrlFormatString="Update_Job.aspx?ID={0}"
